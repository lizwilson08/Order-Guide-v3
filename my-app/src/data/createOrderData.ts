...
export const PRICE_CHANGES_BY_VENDOR: Record<string, PriceChangeProduct[]> = {
  sysco: [
    ...
    { id: "s5", productName: "Organic Milk, Whole, 1-gallon jug", packerId: "7788123", priceDisplay: "$3.49/gal", changePercent: 2.1, isIncrease: true, unit: "gal", unitPrice: 3.49, vendorId: "sysco", imageUrl: "/images/ingredients/Milk.png", lastOrderedDate: "Jan 10, 2025", orderFrequency: "Avg 3 per week" },
    { id: "s6", productName: "Whole Wheat Bread, 20 oz loaves", packerId: "3344556", priceDisplay: "$2.99/loaf", changePercent: 1.5, isIncrease: false, unit: "loaf", unitPrice: 2.99, vendorId: "sysco", imageUrl: "/images/ingredients/wheat-bread.png", lastOrderedDate: "Jan 8, 2025", orderFrequency: "2 per month" },
  ],
  "farmer-bros": [
